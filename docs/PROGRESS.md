...
- **Kaiwa Studio:** KAI-001–009 DONE (media probe). Gate A/B **not accepted**. Next: **KAI-010**.
...
- Kaiwa **KAI-018+** (continuous recorder / journal). KAI-015 ASR deferred without credentials.
