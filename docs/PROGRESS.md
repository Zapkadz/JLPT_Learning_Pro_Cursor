...
- **Kaiwa Studio:** speakable KAI-036–049 DONE; **KAI-046** BLOCKED human. **ADR-020 / KAI-050** auto-subtitle plan DONE (docs). Next code = KAI-051 after approve. Gate A **not accepted**.
