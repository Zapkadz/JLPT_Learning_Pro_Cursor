...
`npm run kaiwa:pronunciation-live-check` — credential-honest; `--sample` parses redacted dumps; no cloud call invented. Evidence: `docs/kaiwa/evidence/kai-026/live/`. Verify: **148/148**.
