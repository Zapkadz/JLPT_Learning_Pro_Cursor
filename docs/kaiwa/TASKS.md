...
KAI-001–014, KAI-016–019 DONE. Next: **KAI-020** (finalize remux / decode check). KAI-015 deferred.
...
| KAI-020 · L · Backend/Media | Finalize take, ghép/remux, kiểm tra decode/duration và lưu bản thu | KAI-007, KAI-019 | Idempotent finalize; thiếu chunk có lỗi; dữ liệu hợp lệ phát được đầu/giữa/cuối; thiếu tail sau interruption được ghi đúng; không trộn tiếng mẫu vào raw mic track | IN_PROGRESS |
...
```text
Task: KAI-020 — Finalize take remux/decode check
Trạng thái: IN_PROGRESS
Phụ thuộc: KAI-019 DONE
Task tiếp theo: KAI-021
```
